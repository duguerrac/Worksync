...
<body><header>
        <div class="titulo">
            <h1>Ver solicitud de cambia de tarea</h1>
   ...
   <?php 
    ...
    <form action="/worksync/controllers/SolicitudController.php?metodo=buscarParaTarea" method="POST">
        <main>
            ...
            <div class="botonera">
                ...
                <br>
                <button type="button" class="BtVerde" onclick="redirigirABuscarTarea()">Cambiar</button>
                <br>
    ...
    <script>
        ...
        function redirigirABuscarTarea() {
            window.location.href = '/worksync/views/tarea/BuscarTarea.php';
        }
    </script>
</body>
</html>