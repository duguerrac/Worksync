...
<body>
    ...
    ?>
    <form action="/worksync/controllers/UsuarioController.php?metodo=buscarUsuario" method="POST">
        <main>
    ...
    <script>
        ...
        function buscar() {
            ...
            window.location.href = "/worksync/controllers/UsuarioController.php?metodo=buscarUsuario&documento=" + documento;           
            }
